...
<title>Wait a moment... | scrumzu</title>
...
<body>
	<div class="center errorpage">
	<img src="/scrumzu/resources/img/404.png" class="left">
		<h1>Wait a moment...</h1>
		<p>Project "${exception.alias}" you've been looking for does not exist. It could have been deleted or has never existed.</p>
		<p><a href="/scrumzu">Go back to home page</a></p>
	</div>
</body>
</html>